...
public class InitialActivity extends AppCompatActivity {
    ...
    public void viewRecipes(View v) {
        ...
        TextView recipeTextViewIngredients = (TextView) findViewById(R.id.ingredients);
        recipeTextViewIngredients.setText(R.string.recipe_ingredients);
        TextView recipeTextViewText = (TextView) findViewById(R.id.recipeText);
        recipeTextViewText.setText(R.string.blueberry_recipe);
    }

    public void viewSources(View v){
        setContentView(R.layout.activity_credit);
        TextView recipeTextView = (TextView) findViewById(R.id.creditText);
        recipeTextView.setText(R.string.credit_links);
